...
public class CocoaUtil {
	...
	public static Object invokeMethod(Class<?> class1, String methodName, Object[] args)
			throws IllegalArgumentException, IllegalAccessException, InvocationTargetException,
			SecurityException, NoSuchMethodException {
		return invokeMethod(class1, null, methodName, args);
	}
	...
	/**
	 * Specialized method. Its behavior is isolated and different enough from
