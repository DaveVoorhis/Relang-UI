...
import static org.reldb.relang.core.strings.Strings.*;
...
import org.reldb.relang.core.compiler.ForeignCompilerJava;
import org.reldb.relang.core.exceptions.ExceptionFatal;
import org.reldb.relang.core.strings.Str;
...
public class TupleTypeGenerator {
	...
	public ForeignCompilerJava.CompilationResults compile() {
		...
		var tupleDef = 
			"import " + Version.getProductPackage() + ".tuples.Tuple;\n\n" +
