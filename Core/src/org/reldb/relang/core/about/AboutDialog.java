package org.reldb.relang.core.about;
...
public class AboutDialog extends Dialog {
	...
	private void createContents() {
		...
		shell.setText("About " + Version.getAppName());
		...
		shell.addPaintListener(e -> {
			...
			e.gc.drawText(Version.getAppName(), 10, 20, true);
			width = e.gc.textExtent(Version.getAppSubtitle()).x;
			e.gc.drawText(Version.getAppSubtitle(), rightPos - width, 20, true);
		});
