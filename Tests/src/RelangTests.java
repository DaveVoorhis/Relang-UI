...
public class RelangTests {
	...
	// Array of packages containing tests.
	private static final String tests[] = {
		"org.reldb.relang.tests.main",
	};
	...
	public static void main(String args[]) {
		...
		try {
			CodeSource src = RelangTests.class.getProtectionDomain().getCodeSource();
			URL jarURL = null;
		...
		System.out.println("Relang tests are running.  Please wait.");
