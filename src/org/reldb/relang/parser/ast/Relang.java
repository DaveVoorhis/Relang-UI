/* Generated By:JJTree&JavaCC: Do not edit this line. Relang.java */
package org.reldb.relang.parser.ast;
public class Relang/*@bgen(jjtree)*/implements RelangTreeConstants, RelangConstants {/*@bgen(jjtree)*/
  protected JJTRelangState jjtree = new JJTRelangState();void jjtreeOpenNodeScope( Node node )
  {
    ((org.reldb.relang.parser.BaseASTNode)node).first_token = getToken(1);
  }

  void jjtreeCloseNodeScope( Node node )
  {
    ((org.reldb.relang.parser.BaseASTNode)node).last_token = getToken(0);
  }
...
//
 ...
 jjtreeOpenNodeScope(jjtn000);Token t;
  ...
  public RelangTokenManager token_source;
  ...
  public Relang(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Relang(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new RelangTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Relang(java.io.Reader stream) {
  ...
  public Relang(RelangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(RelangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
